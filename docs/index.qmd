...
-   **RQ3:** What would  most effective information channels to
    increase the visibility of the ETH?
...
The study shows, that overall the awareness of the ETH Department for Sustainability is moderate. Among the participants 14 out of 21 participants had heard of it previous to the study. 

Unabhängig von dieser Antwort, wurde in der Studie zudem untersucht, inwieweit die ETH member die inititiven des ETH departements kennen. Aus der Untersuchung geht hervor, dass die initiativen deutlich unbekannter als das Departement selbst sind. 

As seen in @fig-initiatives, the Net Zero initiative is the most known (66% of participants heard of it), followed by the SDG Public Lecture Seties and the Sustainable Gastronomy Project (33% of participants heard of it respectively).

```{r}
#| label: fig-initiatives
#| fig-cap: Awareness of the ETH Sustainability Department´s initiatives among ETH domain members.
...
To explore how aware ETH members were of this initiative further questions were asked regarding specific ETH Net Zero measures. Specifically, participants were first asked to assess their familiarity with the Net Zero on a scale from "not familiar at all" to "very familiar" and then which of these measures they heard of. From @fig-netzeromeasures it is visible, that the "Decarbonised Campus" initiative is the most known.
...
awareness_net_zero_measures <- eth_dep_sus_visibility_visual %>%
  ...
  mutate(Measure = measure_labels[Measure])  # Use the labels defined earlier
...
While the work of the ETH sus, this is contrasted by the answers regarding the visibility of the department. While the participants group presented very high interest in sustainability and climate change mitigation and high support of an ETH-wide sustainability strategy, the visibility was rated as 2.40 on a scale from 0-not visible at all to 5-very visible.
...
Um festzustellen, welcher INformationschannel am effektivsten ist, wird zunächst untersucht, wo die Participants von den jeweiligen initiativen gehört haben. 

In einem zweiten Schritt wurden die Teilnehmer gefragt, über welchen Informationskanal sie most likely von der Arbeit erfahren würden. 
Es ist daher wichtig zu sehen, wo die Teilnehmer die Informationen erhalten, um festzustellen welches Medium für die Informationdiffusion besonders effektiv ist.
...
# Conclusions
Zusammenfassend kann gesagt werden, dass die Arbeit des ETH Sustainibility Departments moderat sichtbar ist, jedoch als Einheit nicht visible sind. Das zeigt sich unter anderem daran, dass einige Initiativen mehr Bekanntheit haben, als das Department selbst. Es lässt sich daraus schliessen, dass die Arbeit des Departememts nicht mit den Urhebern in Verbindung gebracht werden.
While the study is not representative, it confirms the Department's self-assessment that their visibility needs to further increase.
Die Studie hat die folgenden Limitationen: Es handelt sich um eine nicht-repräsentative Studie, in der überproportional viele Studierende am Standort Hönggerberg mitgemacht haben. Es bleibt zu untersuchen, ob die results sich bei repräsentativer Zusammenstellung nach affiliation group und Arbeitsort ändern würden.
